    ...
    <Container>
      <Logo style={{width: "60vw"}}/>
      {
        classData ? (
          ...
          <LinkWrapper onClick={()=>window.open(classData.alternateLink, "_blank")}>
        ...
        coursework.courseWork ? (
          coursework.courseWork.map((cw) => {
            return (
              ...
              <SyncedTo aria-label="Click to mark coursework" onClick={()=>startMarking(cw.materials[0].form.responseUrl)}>
                <h3>
                {cw.title}
                </h3>
                <Right>
                ...
                <p>
                  {`${Math.floor(Math.random() * 4)}/3 students have completed this.`}
                </p>
                </Right>
              </SyncedTo>
              </Tooltip>
